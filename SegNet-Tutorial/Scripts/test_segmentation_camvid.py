...
caffe_root = '/home/GRAPHICS2/hse_ashevchenko/SegNet_caffe/caffe-segnet/' 			# Change this to the absolute directoy to SegNet Caffe
import sys
...
print(args.model, args.weights, args.iter)
